...
<div class="col-md-3" id="select" style="display: none">
    <form action="searchMobile" id="selfrom" method="post">
        <div class="field">
            <label>品牌</label>
...
<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
    <div class="btn-group me-2" role="group" aria-label="Second group">
        ...
        &nbsp;
        <a href="searchMobile?pageNum=1&brand=${brand}&type=${type}&minPrice=${minPrice}&maxPrice=${maxPrice}">
            <button type="button" class="btn btn-secondary">回到首页</button>
        </a>
        &nbsp;
        <a href="searchMobile?pageNum=${pageInfo.pageNum==1?1:pageInfo.pageNum-1}&brand=${brand}&type=${type}&minPrice=${minPrice}&maxPrice=${maxPrice}">
            <button type="button" class="btn btn-secondary">上一页</button>
        </a>
        &nbsp;
        <a href="searchMobile?pageNum=${pageInfo.pageNum==pageInfo.pages?pageInfo.pageNum:pageInfo.pageNum+1}&brand=${brand}&type=${type}&minPrice=${minPrice}&maxPrice=${maxPrice}">
