...
<div class="btn-group me-2" role="group" align="center">
    <a href="searchBookPage?pageNum=${pageInfo.pageNum==1?1:pageInfo.pageNum-1}&name=${name}&category=${category}&author=${author}&minPrice=${minPrice}&maxPrice=${maxPrice}">
    ...
    &nbsp;
    <a href="searchBookPage?pageNum=${pageInfo.pageNum==pageInfo.pages?pageInfo.pageNum:pageInfo.pageNum+1}&name=${name}&category=${category}&author=${author}&minPrice=${minPrice}&maxPrice=${maxPrice}">
