...
public class BirdGame extends JPanel {
    ...
    public BirdGame() throws IOException {
        ...
        endImage = ImageIO.read(getClass().getResource("/resources/gameover.png"));
    ...
    public void paint(Graphics g) {
        ...
        //绘制柱子
        g.drawImage(column1.image, column1.x - column1.weight / 2,
                column1.y - column1.height / 2, null);
        g.drawImage(column2.image, column2.x - column2.weight / 2,
                column2.y - column2.height / 2, null);

        //绘制小鸟(旋转坐标系)
        Graphics2D g2 = (Graphics2D) g;
        g2.rotate(-bird.alpha, bird.x, bird.y);
        g.drawImage(bird.image, bird.x - bird.weight / 2,
